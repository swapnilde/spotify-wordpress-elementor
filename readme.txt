...
1. PulseShare Settings Page - Here you can add your Spotify Client ID and Client Secret.
2. PulseShare Settings Page - Here you can add your Spotify Album ID and Podcast ID.
3. Block editor - Here you can add the PulseShare blocks in block editor.
